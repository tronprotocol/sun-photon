...
var DEFAULT_CONFIG_FILENAME = "sun-photon.js";
var BACKUP_CONFIG_FILENAME = "sun-photon-config.js"; // For Windows + Command Prompt
...
function Config(truffle_directory, working_directory, network) {
  ...
  var props = {
    ...
    fullHost: {
      get: function () {
        try {
          return self.network_config.mainFullHost
        } catch (e) {
    ...
    mainFullHost: {
      get: function () {
        try {
          ...
          return default_tx_values.mainFullHost
        }
      },
      set: function () {
        throw new Error("Don't set config.mainFullHost directly. Instead, set config.networks and then config.networks[<network name>].mainFullHost")
      }
    },
    sideFullHost: {
      get: function () {
        try {
          return self.network_config.sideFullHost
        } catch (e) {
          return default_tx_values.sideFullHost
        }
      },
      set: function () {
        throw new Error("Don't set config.sideFullHost directly. Instead, set config.networks and then config.networks[<network name>].sideFullHost")
      }
    },
    mainGateway: {
      get: function () {
        try {
          return self.network_config.mainGateway
        } catch (e) {
          return default_tx_values.mainGateway
        }
      },
      set: function () {
        throw new Error("Don't set config.mainGateway directly. Instead, set config.networks and then config.networks[<network name>].mainGateway")
      }
    },
    sideGateway: {
      get: function () {
        try {
          return self.network_config.sideGateway
        } catch (e) {
          return default_tx_values.sideGateway
        }
      },
      set: function () {
        throw new Error("Don't set config.sideGateway directly. Instead, set config.networks and then config.networks[<network name>].sideGateway")
      }
    },
    chainId: {
      get: function () {
      ...
      set: function () {
        throw new Error("Don't set config.chainId directly. Instead, set config.networks and then config.networks[<network name>].chainId")
      }
    },
    fullNode: {
      get: function () {
