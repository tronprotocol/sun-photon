...
function normalizeURL(url) {
  url = url || "https://github.com/tronprotocol/sun-photon.git#bare-box";
  ...
  if (url.indexOf("/") == -1) { // repo name only
    ...
    return "https://github.com/tronprotocol/sun-photon.git#bare-box";
  }
...
var command = {
  command: 'unbox',
  description: 'Download a sun-photon Box, a pre-built sun-photon project',
  builder: {},
